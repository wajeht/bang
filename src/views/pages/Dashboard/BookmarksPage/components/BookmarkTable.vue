    ...
    <div class="flex justify-between">
      ...
      <div class="flex gap-2 items-center">
        ...
        <div class="form-control">
          <input v-model="states.search" type="text" placeholder="Search"
        ...
        <div class="flex gap-2">
          ...
          <Button v-if="states.check.bookmarks.length > 0" class="btn-neutral btn-xs" @click="deleteAllBookmarks"
    ...
    <div class="overflow-hidden">
      <table class="table bg-white rounded-md">
        ...
        <tbody v-else v-auto-animate>
          <!-- row -->
          <tr v-for="bookmark in computedSearch" :key="`bookmark-id-${bookmark.id}`"
            :class="{ 'bg-neutral-200': states.check.bookmarks.includes(bookmark) }" class="w-fit h-fit">
            <!-- checkbox -->
            <th class="align-middle w-fit h-fit">
              <input type="checkbox" class="checkbox checkbox-xs" v-model="states.check.bookmarks" :value="bookmark" />
            </th>
